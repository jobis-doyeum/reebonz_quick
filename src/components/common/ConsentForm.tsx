...
type ConsentType = 'newsletter' | 'contact' | 'feedback' | 'event'
...
// 수집 목적 반환
const getCollectionPurpose = (type: ConsentType): string => {
...
// 수집 항목 반환
const getCollectionItems = (type: ConsentType): string => {
  const items: Record<ConsentType, string> = {
    newsletter: '이메일 주소',
...
// 보유 기간 반환
const getRetentionPeriod = (type: ConsentType): string => {
  const periods: Record<ConsentType, string> = {
